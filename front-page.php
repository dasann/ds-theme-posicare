...
<main>
    ...
    <section class="section trust-section">
        <div class="container trust-grid">
            ...
            <div class="trust-points card pp-reveal pp-delay-1">
                <ul>
                    <li><?php echo esc_html(get_theme_mod('trust_point_1', 'Inhabergeführtes Familienunternehmen')); ?></li>
                    <li><?php echo esc_html(get_theme_mod('trust_point_2', 'Persönliche Ansprechpartner')); ?></li>
                    <li><?php echo esc_html(get_theme_mod('trust_point_3', 'Kompetente ambulante Versorgung')); ?></li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <section class="section team-section">
        <div class="container trust-grid">
            ...
            <div class="trust-points card pp-reveal pp-delay-1">
                <ul>
                    <li><?php echo esc_html(get_theme_mod('team_point_1', 'Inhabergeführtes Familienunternehmen')); ?></li>
                    <li><?php echo esc_html(get_theme_mod('team_point_2', 'Persönliche Ansprechpartner')); ?></li>
                    <li><?php echo esc_html(get_theme_mod('team_point_3', 'Kompetente ambulante Versorgung')); ?></li>
                </ul>
            </div>
        </div>
    </section>
