...
define('POSITIVEPFLEGE_PRO_VERSION', '1.2.1');
...
function positivepflege_pro_assets() {
    ...
    wp_enqueue_style('positivepflege-pro-style', get_stylesheet_uri(), [], POSITIVEPFLEGE_PRO_VERSION . '-' . filemtime(get_stylesheet_directory() . '/style.css'));
    wp_enqueue_style('positivepflege-pro-main', get_template_directory_uri() . '/assets/css/main.css', ['positivepflege-pro-style'], POSITIVEPFLEGE_PRO_VERSION . '-' . filemtime(get_template_directory() . '/assets/css/main.css'));
    wp_enqueue_script('positivepflege-pro-main', get_template_directory_uri() . '/assets/js/main.js', [], POSITIVEPFLEGE_PRO_VERSION . '-' . filemtime(get_template_directory() . '/assets/js/main.js'), true);
}
